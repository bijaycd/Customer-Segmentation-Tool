# Building Customer Segmentation Tool
...
You can access the application created in [Web App](https://customer-segmentation-tool.streamlit.app/) and see more information of dataset at [Kaggle](https://www.kaggle.com/datasets/kyanyoga/sample-sales-data).
